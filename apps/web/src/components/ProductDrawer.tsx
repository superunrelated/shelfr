...
export function ProductDrawer({
  ...
  return (
    <aside className="w-96 flex-shrink-0 bg-white border-l border-neutral-200/80 flex flex-col overflow-hidden hidden md:flex">
      {/* Image */}
      <div
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute top-3 right-3 w-8 h-8 rounded bg-white/90 text-neutral-400 flex items-center justify-center hover:text-neutral-600 shadow-sm z-10"
      ...
      <div className="flex items-center justify-center gap-1 px-4 py-2.5 border-t border-neutral-200/80 flex-shrink-0">
        {product.source_url && (
          <a
            ...
            rel="noopener noreferrer"
            title="Open in shop"
            className="p-2 rounded text-neutral-400 hover:text-[#1c1e2a] hover:bg-neutral-100 transition-colors"
          >
        ...
        {product.source_url && (
          <button
            ...
            className="p-2 rounded text-neutral-400 hover:text-[#1c1e2a] hover:bg-neutral-100 transition-colors disabled:opacity-50"
          >
            <RiRefreshLine
              size={16}
        ...
        <button
          ...
          className="p-2 rounded text-neutral-400 hover:text-amber-600 hover:bg-amber-50 transition-colors"
        >
        ...
        <button
          ...
          className="p-2 rounded text-neutral-300 hover:text-red-500 hover:bg-red-50 transition-colors"
        >
